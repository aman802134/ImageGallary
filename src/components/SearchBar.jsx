  ...
  return (
    <>
      ...
      <div className='w-full'>
        ...
        <button className=' absolute w-36 xs:w-24 md:w-36 py-3 rounded-tr-md rounded-br-md bg-green border-none outline-none hover:bg-darkGreen text-white font-roboto font-normal tracking-wide text-lg'>search</button>
      </div>
      </form>
    </>
  )
